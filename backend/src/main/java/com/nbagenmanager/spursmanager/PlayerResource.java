 ...
 * @author Ryan Chin
 */
//Controller class to connect to front end
@RestController
...
public class PlayerResource {
    ...
    //Clear the roster by deleting all players
    @DeleteMapping("/clear")
    public ResponseEntity<String> clearRoster(){
        playerService.clearRoster();
        return new ResponseEntity<>(HttpStatus.OK);
    }
    
    //Get the ranking of players based on their performance
    @GetMapping("/ranking")
