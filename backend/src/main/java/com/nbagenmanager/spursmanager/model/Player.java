...
public class Player implements Serializable{
    ...
    //Player constructor
    public Player(Long id, String name, int age, double height, double weight, String position, double salary, double points, double rebound, double assists, double steals, double blocks, double compScore) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.height = height;
